...
/*
 * EFFECT_DOWN_UP_CROSSFADE (13) — зеркальная пара к EFFECT_UP_DOWN_CROSSFADE (12):
 * полоса перехода той же высоты едет СНИЗУ ВВЕРХ. Формула та же, что у 12, с
 * координатой, отсчитанной от нижнего края (resolution.y - p).
 */
...
void main() {
        ...
        // current pixel y-coordinate, measured from the BOTTOM edge
        float p = resolution.y - tex_coord.y * resolution.y;
